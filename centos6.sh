...
wget -O /etc/iptables.up.rules "https://raw.githubusercontent.com/masbakti/vps/master/iptables.up.rules"
...
cd /etc/openvpn/
wget -O /etc/openvpn/1194-client.ovpn "https://raw.githubusercontent.com/masbakti/vps/master/1194-client.conf"
sed -i $MYIP2 /etc/openvpn/1194-client.ovpn;
PASS=`cat /dev/urandom | tr -dc 'a-zA-Z0-9' | fold -w 15 | head -n 1`;
useradd -M -s /bin/false masbakti
echo "masbakti:$PASS" | chpasswd
echo "masbakti" > pass.txt
echo "$PASS" >> pass.txt
...
# install mrtg
cd /etc/snmp/
wget -O /etc/snmp/snmpd.conf "https://raw.githubusercontent.com/masbakti/vps/master/snmpd.conf"
wget -O /root/mrtg-mem.sh "https://raw.githubusercontent.com/masbakti/vps/master/mrtg-mem.sh"
...
curl "https://raw.githubusercontent.com/masbakti/vps/master/mrtg.conf" >> /etc/mrtg/mrtg.cfg
...
wget https://raw.githubusercontent.com/masbakti/vps/master/vnstat_php_frontend-1.5.1.tar.gz
...
# install squid
yum -y install squid
wget -O /etc/squid/squid.conf "https://raw.githubusercontent.com/masbakti/vps/master/squid-centos.conf"
...
echo "./speedtest.py" > /usr/bin/speed
chmod +x speed
...
wget -O userlimit.sh "https://raw.githubusercontent.com/masbakti/vps/master/userlimit.sh"
wget -O userexpired.sh "https://raw.githubusercontent.com/masbakti/vps/master/userexpired.sh"
...
# script gue
cd /usr/bin
wget -O baru "https://raw.githubusercontent.com/masbakti/vps/master/baru.sh"
wget -O trial "https://raw.githubusercontent.com/masbakti/vps/master/trial"
wget -O cek "https://raw.githubusercontent.com/masbakti/vps/master/cek"
wget -O renew "https://raw.githubusercontent.com/masbakti/vps/master/renew"
chmod +x renew
chmod +x baru
chmod +x trial
chmod +x cek
